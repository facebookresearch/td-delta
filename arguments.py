...
def get_args():
    ...
    parser.add_argument('--num-values', type=int, default=1,
                        help='number of value functions to learn')
    parser.add_argument('--sum-values', action='store_true', default=False,
                        help='sum up value functions (for baseline with same params)')
